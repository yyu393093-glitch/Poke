...
export default function NetworkPage() {
  ...
  return <main className="min-h-screen min-w-[1100px] bg-slate-950 p-4 text-slate-100" data-phase={state.phase}>
    <header className="flex h-16 items-center justify-between rounded-t-2xl border border-slate-800 bg-slate-900/90 px-5"><div className="flex items-center gap-3"><span className="grid h-9 w-9 place-items-center rounded-xl bg-gradient-to-br from-sky-300 to-indigo-500 font-black text-slate-950">P</span><div><b>戳戳 Poke</b><small className="block text-slate-500">协作网络 · B 前端</small></div></div><MetricsBar metrics={metrics} /></header>
